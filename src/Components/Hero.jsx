       ...
       <div className='md:p-5 p-3 flex lg:flex-row flex-col justify-between w-full'>
         <div>
            ...
            <div className='mt-4 flex gap-2'>
             <button className='border p-2.5 font-bold rounded-lg hover:bg-black/70 hover:border-black/70 focus:bg-black/70 focus:border-black/70 transition-all duration-500 flex gap-2 group'>Book an Appointment <ArrowRight className='my-auto -rotate-30 group-hover:rotate-0 transition-all duration-400' size={20}/> </button>
