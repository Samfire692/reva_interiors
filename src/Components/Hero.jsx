       ...
       <div className='md:p-5 p-3 flex lg:flex-row flex-col justify-between w-full'>
         <div>
            ...
            <div className='mt-4 flex gap-2'>
             <a href='#booking' className='border p-2.5 font-bold rounded-lg hover:bg-black/70 hover:border-black/70 focus:bg-black/70 focus:border-black/70 transition-all duration-500 flex gap-2 group'>Book an Appointment <ArrowRight className='my-auto transition-all' size={18}/> </a>

             <a href='#contacts' className='p-2.5 font-bold rounded-lg max-w-40 bg-amber-300/30'>Contact Us</a>
            </div>
         </div>
